...
//                                     width={200}
//                                     height={300}
//                                     className="w-[25rem] h-[25rem] object-cover rounded-2xl shadow-2xl transition-transform duration-300 group-hover:scale-105"
//                                 />
...
export default function Founder() {
    return (
        <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-white px-4 relative overflow-hidden">
            {/* Background Pattern */}
                ...
                <svg className="w-full h-full" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                    <defs>
                        <pattern id="blueprint" x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse">
                            <rect width="20" height="20" fill="none" stroke="#003e76" strokeWidth="0.5" />
                            <rect x="5" y="5" width="10" height="10" fill="none" stroke="#003e76" strokeWidth="0.3" />
                            <circle cx="10" cy="10" r="1" fill="#003e76" opacity="0.3" />
                        </pattern>
                    </defs>
                    <rect width="100%" height="100%" fill="url(#blueprint)" />
                </svg>
            ...
            {/* Decorative elements */}
            <div className="absolute top-10 left-10 w-20 h-20 border-2 border-[#003e76]/10 rounded-full"></div>
            <div className="absolute bottom-20 right-20 w-32 h-32 border border-[#003e76]/10 rounded-lg rotate-45"></div>
            ...
            <div className="max-w-6xl w-full relative z-10 text-center">
                ...
                <div className="flex justify-center items-center space-x-4 mb-10">
                    ...
                    <div className="w-3 h-3 bg-[#003e76] rounded-full"></div>
                    <div className="w-16 h-1 bg-[#003e76]"></div>
                </div>
                ...
                <div className="grid lg:grid-cols-2 gap-10 items-center justify-items-center">
                    ...
                    <div className="relative group w-full max-w-md">
                        ...
                        />
                        {/* Overlay */}
                        <div className="absolute bottom-4 left-4 right-4 bg-white/95 backdrop-blur-sm rounded-xl p-4 shadow-lg transform translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
                            <div className="flex items-center justify-between text-left">
                                <div>
                                    <div className="text-2xl font-bold text-[#003e76] mb-1">MS</div>
                                    <div className="text-xs text-gray-600">Est. 1993</div>
                                </div>
                                <div className="text-right">
                                    <div className="text-sm font-semibold text-[#003e76]">32+ Years</div>
                    ...
                    <div className="space-y-6 max-w-xl text-center lg:text-left">
                        <h3 className="text-3xl md:text-4xl font-bold text-[#003e76] leading-tight">
                            HON. MUKESH SHARMA
                        </h3>
                        <p className="text-xl font-medium text-gray-700">
                            Founder & Principal Engineer — <span className="text-[#003e76]">Mukesh Sharma & Associates</span>
                        </p>
                        <p className="text-gray-700 leading-relaxed">
                            With a passion for engineering excellence, he founded <strong className="text-[#003e76]">Mukesh Sharma & Associates</strong> in 1993.
                            With <strong>32+ years</strong> of experience, his vision continues to shape the firm’s future through innovation and integrity.
                        </p>
                        <div className="grid grid-cols-3 gap-6 text-center">
                            <div>
                                <div className="text-3xl font-bold text-[#003e76]">32+</div>
                                <div className="text-sm text-gray-600">Years</div>
                            </div>
                            <div>
                                <div className="text-3xl font-bold text-[#003e76]">200+</div>
                                <div className="text-sm text-gray-600">Projects</div>
                            </div>
                            <div>
                                <div className="text-3xl font-bold text-[#003e76]">1993</div>
                                <div className="text-sm text-gray-600">Founded</div>
                            </div>
                        </div>

                        {/* Signature */}
                        <div className="flex items-center justify-center lg:justify-start space-x-3 px-6 py-4 bg-gray-50 rounded-xl">
                            <div className="text-2xl font-script text-[#003e76] italic">
                                Mukesh Sharma
                            </div>
                            <div className="w-8 h-px bg-[#003e76]"></div>
                        </div>
                    </div>
                </div>
            </div>
